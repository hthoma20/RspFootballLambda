...
ACTION_HANDLERS = [
    ...
    handlers.PuntActionHandler(),
    handlers.PuntKickActionHandler(),
    handlers.FakePuntChoiceActionHandler(),
    handlers.KickBlockActionHandler(),
    handlers.SackActionHandler(),
    handlers.SackChoiceActionHandler(),
    handlers.PickRollActionHandler(),
    handlers.DistanceRollActionHandler(),
    handlers.PickReturnActionHandler(),
    handlers.PickReturn6ActionHandler(),
    handlers.PickTouchbackChoiceActionHandler(),
